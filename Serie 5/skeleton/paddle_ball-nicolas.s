...
rightPaddle:
    /*This is calles when the LED stands on 1 (far right). When Button 1 is pressed then the score
     gets increased by 1. In this version a sound is made, when the button 1 IS pressed.
     */
	STMDB   SP!, {R0,LR}
    ...
    //Checks if button 1 is pressed. When it IS pressed it jumps to makeSound
	CMP	    R0, #0
	BLNE	makeSound
